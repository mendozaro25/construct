    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url() ?>especialidades/especialidad"><?= $uri["title"] ?></a></li>
            </ol>
        </div>
                ...
                <div class="card-body">
                    <div class="">
                        <table id="table1" class="table table-striped table-bordered">
                            ...
                            <tr>
                                <th width="10px">id</th>
                                <th width="80px">especialidad</th>
                                <th width="350px">descripcion</th>
                                <th width="10px">estado</th>
                                <th width="37px">acc.</th>
                            </tr>
                            </thead>
                        </table>
                    </div>
