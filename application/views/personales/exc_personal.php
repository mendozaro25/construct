    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="excelUploadModalLabel">Importar Personal</h5>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <a href="<?= base_url().UPLOAD_PATH_PERSON_FORMAT ?>" target="_blank"><button class="btn btn-light">Descargar Formato .xlsx</button></a>
                        </div>
                    </div>
                </div>
            </div>
            <form id="excelUploadForm" action="<?= base_url() ?>personales/upload_excel" method="post" enctype="multipart/form-data">
