    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url() ?>personales/personal"><?= $uri["title"] ?></a></li>
            </ol>
        </div>
        <div class="page-rightheader">
            <div class="btn btn-list">
                ...
                <button type="button" class="btn btn-success" onclick="openExcelUploadModal()">
                    <i class="fe fe-upload mr-1"></i>Importar Personal
                </button>
            </div>
        </div>
    </div>
