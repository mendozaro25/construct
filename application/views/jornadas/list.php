    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="<?= base_url() ?>jornadas/jornada"><?= $uri["title"] ?></a></li>
            </ol>
        </div>
        <div class="page-rightheader">
            <div class="btn btn-list">
                <button type="button" data-toggle="tooltip" data-placement="left" class="btn btn-danger" title="Agregar obra" onclick="openForm()">
                    <i class="fe fe-plus mr-1" ></i>Agregar Obra
                </button>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="">
                        <table id="table1" class="table table-striped table-bordered">
                            ...
                            <tr>
                                <th width="10px">id</th>
                                <th width="120px">nombre obra</th>
                                <th width="20px">costo</th>
                                <th width="80px">finicio</th>
                                <th width="80px">ffinal</th>
            ...
            "columnDefs": [
                ...
                },
                {
                    ...
                    "render": function( data, type, row) {
                        var h = Mustache.render($("#tplDtColumnJornada").html(),
                                {
                                    row_id:  data.id,
